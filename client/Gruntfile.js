...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        yeoman: yeomanConfig,
         ...
         concat: {
            emberRoute: {
                src: ['<%= yeoman.app%>/routes/**/*.js'],
                dest: '<%= yeoman.app %>/scripts/routes.js'
            },
            emberController: {
            ...
            emberModel: {
                src: ['<%= yeoman.app%>/models/**/*.js'],
                dest: '<%= yeoman.app %>/scripts/models.js'
            },
            emberView: {
                src: ['<%= yeoman.app%>/views/**/*.js'],
                dest: '<%= yeoman.app %>/scripts/views.js'
            },
            emberComponents: {
